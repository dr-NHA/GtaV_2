...
fLocal_56=85.7173f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18)) func_32();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("ambient_tonyacall5")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
while (true){
...
if(SYSTEM::VDIST2(uLocal_46, uLocal_43) > fLocal_42) func_32();
switch (iLocal_37){
case 0:
...
if(num==0)if(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL5", 8, 0, 0, 0)) iLocal_40=2;
elseif(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL6", 8, 0, 0, 0)) iLocal_40=2;
}}
break;
case 2:
