...
fLocal_42=2500f;
uLocal_43={
409.1539f, -1626.6769f, 28.2928f 
};
uLocal_49={
409.27472f, -1623.0219f, 28.29278f 
};
fLocal_52=202.6928f;
uLocal_53={
415.6071f, -1647.6045f, 28.2928f 
};
fLocal_56=85.7173f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18)) func_33();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("ambient_tonyacall2")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
while (true){
PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID());
if(func_32(0, 14)) func_33();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) uLocal_46={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
if(SYSTEM::VDIST2(uLocal_46, uLocal_43) > fLocal_42) func_33();
switch (iLocal_37){
case 0:
if(func_28()) iLocal_37=1;
break;
case 1:
...
if(STREAMING::HAS_MODEL_LOADED(joaat("prop_phone_ing")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_stand_mobile@female@standing@call@enter") && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_stand_mobile@female@standing@call@base") && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_stand_mobile@female@standing@call@exit")) iLocal_37=2;
break;
case 2:
if(func_1()) iLocal_37=3;
break;
case 3:
func_33();
break;
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_38, false)) entityCoords2={
ENTITY::GET_ENTITY_COORDS(pedLocal_38, true) 
};
else entityCoords2={
408.5002f, -1624.5825f, 29.2928f 
};
if(SYSTEM::VDIST2(entityCoords, entityCoords2) > 10000f || ENTITY::IS_ENTITY_DEAD(pedLocal_38, false) || func_27()) return true;
switch (iLocal_40){
case 0:
...
}}}elseif(TASK::GET_SEQUENCE_PROGRESS(pedLocal_38)==2){
num=MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2;
if(num==0)if(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL3", 8, 0, 0, 0)) iLocal_40=2;
elseif(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL4", 8, 0, 0, 0)) iLocal_40=2;
}}
break;
case 2:
...
case 4:
func_2();
if(SYSTEM::TIMERA() > 10000) iLocal_40=3;
break;
}
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_38) && !ENTITY::IS_ENTITY_DEAD(pedLocal_38, false))if(ENTITY::DOES_ENTITY_EXIST(obLocal_39))if(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_38, SCRIPT_TASK_START_SCENARIO_IN_PLACE)==1) OBJECT::DELETE_OBJECT(&obLocal_39);
return;
}
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_39)) ENTITY::DETACH_ENTITY(obLocal_39, true, true);
AUDIO::STOP_SCRIPTED_CONVERSATION(false);
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_38))if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_38)) PED::DELETE_PED(&pedLocal_38);
else ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_38);
