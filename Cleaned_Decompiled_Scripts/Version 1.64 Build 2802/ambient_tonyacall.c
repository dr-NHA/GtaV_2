...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("ambient_tonyacall")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
while (true){
...
switch (iLocal_37){
case 0:
if(func_28())if(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_HANG", 8, 0, 0, 0)) iLocal_37=1;
break;
case 1:
...
if(num==0)if(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL1", 8, 0, 0, 0)) iLocal_40=2;
elseif(_CONVERSATION_ADD_LINE(&uLocal_63, "TOWAUD", "TONYA_CALL2", 8, 0, 0, 0)) iLocal_40=2;
}}
break;
case 2:
