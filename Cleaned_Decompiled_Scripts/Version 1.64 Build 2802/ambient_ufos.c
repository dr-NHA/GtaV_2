...
if(!STREAMING::IS_IPL_ACTIVE("ufo")) STREAMING::REQUEST_IPL("ufo");
iLocal_78[0 /*3*/]={
uLocal_68 
};
iLocal_78[1 /*3*/]={
...
if(Global_32168==1) func_12();
if(bLocal_85){
if(!func_10(PLAYER::PLAYER_PED_ID(), iLocal_78[0 /*3*/], 290f + 50f, true))if(!func_10(PLAYER::PLAYER_PED_ID(), iLocal_78[1 /*3*/], 290f + 50f, true)) func_12();
if(iLocal_77 !=0){
...
if(iLocal_76==0) AUDIO::PLAY_SOUND_FROM_COORD(iLocal_92, "SPECIAL_EVIL_UFO_DEATH_RAY", iLocal_78[iLocal_76 /*3*/], 0, false, 0, false);
else AUDIO::PLAY_SOUND_FROM_COORD(iLocal_92, "SPECIAL_EVIL_UFO_DEATH_RAY_3", iLocal_78[iLocal_76 /*3*/], 0, false, 0, false);
func_7();
func_6();
}}else{
iLocal_77=1;
...
func_7();
func_6();
if(MISC::GET_GAME_TIMER() > iLocal_93 + iLocal_94) func_4(&iLocal_92);
...
if(func_2(vehiclePedIsIn)) VEHICLE::SET_VEHICLE_ENGINE_ON(vehiclePedIsIn, true, false, false);
}}
return;
}
...
Vector3 vector;
if(iLocal_76==-1) return;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) return;
if(!func_10(PLAYER::PLAYER_PED_ID(), iLocal_78[iLocal_76 /*3*/], fLocal_88, true)) return;
vector={
func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - iLocal_78[iLocal_76 /*3*/]) *{
fLocal_89, fLocal_89, fLocal_89 
}};
...
Vector3 func__9(float fParam0, var uParam1, var uParam2) // Position - 0x593{
float num;
float num2;
...
if(STREAMING::IS_IPL_ACTIVE("ufo")) STREAMING::REMOVE_IPL("ufo");
func_4(&iLocal_102);
func_4(&iLocal_101);
func_4(&iLocal_92);
AUDIO::SET_AMBIENT_ZONE_STATE_PERSISTENT("AZ_SPECIAL_UFO_01", false, true);
